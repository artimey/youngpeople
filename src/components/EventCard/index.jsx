      ...
      <div className={styles.eventCard}>
        <div className='p-[12px] mb-[15px]'>
          <div className='rounded-[3rem] overflow-hidden'>
            <img className='w-full ' src={allEventsData[item].img} alt="alt" />
          </div>
        </div>

        <div className='px-[24px] mb-[12.5rem]'>
          <Link to={`/events/${allEventsData[item].slug}`} className={styles.eventTitle}>{allEventsData[item].title}</Link>
