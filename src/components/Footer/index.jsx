...
export const MyFooter = () => {
  ...
  const emailData = [
    {title: "Электронная почта", value: 'molodejm@yandex.ru'},
                  ...
                  emailData.map(item => {
                    return (
                      <div key={item.title} className="mb-[24px]">
                        ...
                        <span className='block font-[500] text-[17px] leading-[21.25px] text-white'>{item.value}</span>
                      </div>
                    )
                  })
                }
