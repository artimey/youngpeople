        ...
        <Row>
          <Col span={12} className=''>
            ...
            <div className='flex mb-[85px]'>
              <a href='https://vk.com/molodezh_msk' target="_blank" className='w-[120px] h-[120px] rounded-full  bg-white16 mr-[16px] flex items-center justify-items-center'>
              ...
              <a href='https://t.me/molodezhmsk' target="_blank" className='w-[120px] h-[120px] rounded-[35px] bg-white16 mr-[16px] flex items-center justify-items-center'>
