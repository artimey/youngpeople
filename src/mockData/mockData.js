...
export const coWorkingZonesData = {
  ...
  "party-room": {
    ...
    text: `Зал вмещает до 200 человек. На этой площадке ты сможешь проводить уникальные лекции, конференции, 
      встречаться с единомышленниками для обсуждения масштабных вопросов, организовывать концерты и все, что только захочешь.`,
    img: livingRoom
  },
  "video-studio": {
    slug: "video-studio",
    title: "Видеостудия",
    text: `Профессиональная видеостудия с выставленным освещением позволит осуществить твою мечту: записать подкаст, записать интервью и многое другое. Все в твоих руках.`,
    img: videoStudio
  },
  "content-farm": {
    slug: "content-farm",
    title: "Контент-ферма",
    text: `Воплощай свои самые интересные идеи для социальных сетей здесь. Для тебя организовано креативное пространство, в котором хочется создавать новый контент.`,
    img: contentFarm
  },
  "sport-room": {
    slug: "sport-room",
