...
<strong>
  <a href="https://www.mos.ru/city/projects/studentday/" target="_blank">Подробнее</a>
</strong>
`
...
export const allEventsData = {
  ...
  "sport-moscow": {
    title: "Гонка универов",
    img: cardImage3,
    date: "27 января",
    place: "Легкоатлетический манеж МГСУ",
    org: "«Молодежь Москвы»",
    orgImg: org3,
    slug: "sport-moscow",
    html: event3Html,
...
export const coWorkingZonesData = {
  "coworking": {
    slug: "coworking",
    title: "Коворкинг",
    titleForBooking: "коворкинга",
    text: `В поисках комфортного места для того, чтобы заняться работой или учебой, ты можешь остановиться здесь. 
  ...
  "conference-room": {
    ...
    title: "Переговорка",
    titleForBooking: "переговорки",
    text: `Это место, в котором ты сможешь решать самые важные вопросы своего проекта, 
    организовывать мозговой штурм, а также встречаться с партнерами и проводить презентации.`,
    img: conferenceRoom
  },
  "party-room": {
    slug: "party-room",
    title: "Зал для мероприятий",
    titleForBooking: "зала для мероприятий",
    text: `На этой площадке ты сможешь проводить уникальные лекции, 
    конференции, встречаться с единомышленниками для обсуждения масштабных вопросов, организовывать 
    концерты и все, что только захочешь.`,
    img: livingRoom
  },
  "video-studio": {
    slug: "video-studio",
    title: "Видеостудия",
    titleForBooking: "видеостудии",
    text: `Профессиональная видеостудия с выставленным освещением позволит осуществить твою мечту: 
    записать подкаст, интервью и многое другое. Все в твоих руках.`,
    img: videoStudio
  },
  "content-farm": {
    slug: "content-farm",
    title: "Контент-ферма",
    titleForBooking: "контент-фермы",
    text: `Воплощай свои самые интересные идеи для социальных сетей здесь. Для тебя организовано 
    креативное пространство, в котором хочется создавать новый контент. `,
    img: contentFarm
  },
  "sport-room": {
    slug: "sport-room",
    title: "Зал для тренировок и танцевальных занятий",
    titleForBooking: "зала для тренировок и танцевальных занятий",
